		...
		<div class="accordion-item">
			...
			<div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFaq">
				<div class="accordion-body">
					...
					<p>Ethereum's entry and exit queues are ETH waiting to begin staking or to unstake. The network has a rate limit on how much ETH can be processed per epoch (referred to as churn). If more ETH is trying to enter or exit than can be processed, then they are placed in the respective queue.</p>

					<p class="fw-bold text-decoration-underline mb-2">Why is there a queue?</p>
					<p>Ethereum's entry and exit queues are mechanisms to protect the stability of Ethereum's proof of stake (PoS) consensus.</p>

					<p class="fw-bold text-decoration-underline mb-2">Will the queue go away or always be this long?</p>
					<p>If ETH is joining the entry or exit queues at a faster rate than the churn (how quickly they're processed), then the queue and wait times will increase. If no more ETH joins the queue, or less join than the churn rate, then the queue and wait times will decrease.</p>

					<p class="fw-bold text-decoration-underline mb-2">What is churn?</p>
					<p>The churn is a rate limit on the amount of ETH that can enter or exit per epoch. This throttling mechanism helps prevent instability in consensus.</p>
